...
- [编码器](encoder): 
    ...
    - 例子: 
        ...
        - 电容: [AMT103 CUI <i class="fa fa-external-link"></i>](https://www.mouser.fr/ProductDetail/CUI-Devices/AMT103-V?qs=%2Fha2pyFaduiAsBlScvLoAWHUnKz39jAIpNPVt58AQ0PVb84dpbt53g%3D%3D)
...
## 支持附加的传感器
如果你有兴趣了解如何使你的代码在不同类型的传感器或通信中运行,这个接口已经在Arduino SimpleFOClibrary中实现了，看看这个简短的例子 [如何实现用新的传感器](sensor_support). 
